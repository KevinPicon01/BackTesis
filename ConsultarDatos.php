            ...
            <div class="card ">
                ...
                <div class="card-body">
                    <form action="" >
                        ...
                        <input class="form-control"  id="Date" value="<?= $_GET['Date'] ?? "" ?>" type="datetime-local" name="Date">
                        <br>
                        <label  class="form-label" for="Date2">Fecha Final:</label>
                        <input class="form-control" id="Date2" value="<?= $_GET['Date2'] ?? "" ?>" type="datetime-local" name="Date2">
